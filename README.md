...
This portfolio showcases my manual testing projects, documentation, and QA process.  
Each project follows a structured **Agile/Scrum** workflow and demonstrates hands-on use of **Jira**, **TestRail**, **Postman**, **Excel**, and **Word**.
...
**Highlights:**
- Full Test Plan & Regression Suite  
...
**Author:** Bart  
**Role:** Manual QA / Software Tester  
**Focus:** Functional, Exploratory & API Testing
